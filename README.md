...
To make this qualitative analysis statistical robust we performed two different regression on our dataset: *linear* fit and *quadratic* fit, then evaluate the $R^2$ [score] (https://en.wikipedia.org/wiki/Coefficient_of_determination) score and the [**MSE**](https://en.wikipedia.org/wiki/Mean_squared_error).
